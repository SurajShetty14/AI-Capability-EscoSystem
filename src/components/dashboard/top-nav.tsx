          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-white border-mint-100">
              <DropdownMenuItem asChild>
                <Link href="/dashboard/assessments/create" className="flex items-center space-x-2 cursor-pointer">
                  <FileText className="h-4 w-4 text-text-subtle" />
                  <span>New Assessment</span>
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link href="/dashboard/candidates/add" className="flex items-center space-x-2 cursor-pointer">
