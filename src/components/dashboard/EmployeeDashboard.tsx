    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full border-2 border-mint-200">
            ...
            <span className="text-sm font-semibold text-gray-700">12 Active Employees</span>
          </div>

          {/* Need Attention */}
          <div className="flex items-center gap-2 px-4 py-2 bg-amber-50 rounded-full border-2 border-amber-200">
            <AlertCircle className="w-4 h-4 text-amber-600" />
            <span className="text-sm font-semibold text-amber-700">3 Need Attention</span>
          </div>

          {/* Ready to Level Up */}
          <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full border-2 border-blue-200">
            <TrendingUp className="w-4 h-4 text-blue-600" />
            <span className="text-sm font-semibold text-blue-700">5 Ready to Level Up</span>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          ...
          <h3 className="text-4xl font-black text-gray-900 mb-2">47</h3>
