  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={cn(
          "flex items-center gap-2 px-3 py-2 rounded-lg border-2 transition-all font-semibold text-sm whitespace-nowrap",
          mode === 'employees'
            ? "bg-mint-50 border-mint-200 text-mint-700 hover:bg-mint-100"
