            ...
            <div className="flex-1 max-w-[480px] mx-8">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 pr-4 w-full bg-mint-50/60 border-mint-100/40 rounded-xl focus:border-mint-200 focus:ring-2 focus:ring-mint-200/20 focus:bg-white text-text-primary placeholder:text-text-subtle h-11"
                />
              </div>
            </div>
